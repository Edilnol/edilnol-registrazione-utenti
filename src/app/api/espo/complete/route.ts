...
export async function POST(req: Request) {
  ...
  try {
    ...
    const opportunityName = `${body.firstName.trim()} ${body.lastName.trim()} - ${body.interest.trim()}`;
    ...
    const teamId = teamIdByInterest[body.interest.trim()];
